...
class DataTable extends \Phalcon\Mvc\User\Plugin
{
    ...
    /**
     * @param \Phalcon\Mvc\Model\Query\BuilderInterface|\Phalcon\Mvc\Model\Resultset|array|\Klb\Core\Model|string $builder
     * @param string|array $columns
     * @param callable $filter
     * @return \Klb\Core\Grid\DataTable
     */
    public static function of($builder, $columns = [], callable $filter = null)
    {
        ...
        /** @var \Klb\Core\Grid\DataTable $dataTable */
        $dataTable = null;
        ...
        } else if ($builder instanceof \Klb\Core\Grid\Builder\Select) {
    ...
    /**
     * @param \Klb\Core\Grid\Builder\Select $builder
     * @param array $columns
     * @return $this
     * @throws \Klb\Core\Grid\Builder\DbSelectException
     */
    public function fromSelect($builder, $columns = [])
    {
        if (empty($columns)) {
            $columns = $builder->getPart(\Klb\Core\Grid\Builder\Select::COLUMNS);
        }
