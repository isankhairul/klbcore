...
class Model extends \Phalcon\Mvc\Model {
    ...
    /*table name*/
    const TBL_STOCKIST_PICKLIST_PO = 'stockist_picklist_po';
    const TBL_STOCKIST_PICKLIST_ITEM = 'stockist_picklist_item';

    const TBL_STORE = 'store';
    const TBL_SC_USERS = 'sc_users';
    const TBL_SC_ROLES = 'sc_roles';
    const TBL_SC_PERMISSIONS = 'sc_permissions';
    const TBL_SC_SUCCESS_LOGINS = 'sc_success_logins';
    const TBL_SC_PASSWORD_CHANGES = 'sc_password_changes';
    const TBL_SC_RESET_PASSWORDS = 'sc_reset_passwords';
    const TBL_SC_RESOURCES = 'sc_resources';
    const TBL_PRINCIPAL = 'principal';
...
//        $this->setWriteConnectionService("db");
     ...
     * @param \Phalcon\Mvc\Model\Transaction|null $transaction object   Phalcon Trancation object if the entity is part of a transaction
     * @return bool
     * @throws \Exception
     */
