 ...
 * Due to my inability to get the correct accented characters 5000 above, I resulted to using the pipe (|) to represent
 * accent.
 */
class Number
{
    ...
    /**
     * @var ArrayObject[] A map of Roman numerals based on place value. Each item ends with the first numeral in the
     *      next place value.
     * @static
     */
    ...
    /**
     * @var string[]  sA map of numbers and their representative Roman numerals in notation format. This map allows us
     *      to make any numeral by replacing the the notation with the place value equivalent.
     * @static
     */
