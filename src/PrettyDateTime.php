 ...
 *
 * Generates human-readable strings for PHP DateTime objects. It handles dates in the past and future. For future
 * dates, it uses the format 'In x unit', ie: 'In 1 minute'. For dates in the past, it uses 'x unit ago', ie: '2 years
 * ago'.
 *
 * Note: Comparison of dates, for those beyond a day apart, uses the difference between their Unix timestamps.
 *
 * @author  danielst.jules@gmail.com
 *
 * @see     https://github.com/danielstjules/php-pretty-datetime
 * @package App
 */
class PrettyDateTime
{
